...
const AddIcon = (props: Props) => {
    ...
    const [color, setColor] = useState(colorHashDefault)

    return <div style={{ display: 'inline' }} onMouseOver={() => setColor(colorHashActive)} onMouseOut={() => setColor(colorHashDefault)}>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 32 32">
            ...
            <path fill={color} d="M23 14c-4.971 0-9 4.029-9 9s4.029 9 9 9c4.971 0 9-4.029 9-9s-4.029-9-9-9zM28 24h-4v4h-2v-4h-4v-2h4v-4h2v4h4v2z"></path>
        </svg>
    </div>
}
